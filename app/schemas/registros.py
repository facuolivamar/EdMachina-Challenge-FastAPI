...
class RegistroRequest(BaseModel):
    calificacion_final: float | None = Field(gt=0, le=10, description="Calificacion final del Alumno")
    ...
    carrera_id: int = Field(gt=0, description="Carrera relacionada al Registro")
